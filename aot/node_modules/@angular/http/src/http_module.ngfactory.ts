...
class HttpModuleInjector extends import0.NgModuleInjector<import1.HttpModule> {
  ...
  get _BrowserXhr_1():import2.BrowserXhr {
    if ((this.__BrowserXhr_1 == (null as any))) { (this.__BrowserXhr_1 = new import2.BrowserXhr()); }
    return this.__BrowserXhr_1;
  }
  get _ResponseOptions_2():import3.BaseResponseOptions {
    if ((this.__ResponseOptions_2 == (null as any))) { (this.__ResponseOptions_2 = new import3.BaseResponseOptions()); }
    return this.__ResponseOptions_2;
  }
  get _XSRFStrategy_3():any {
    if ((this.__XSRFStrategy_3 == (null as any))) { (this.__XSRFStrategy_3 = import1._createDefaultCookieXSRFStrategy()); }
    return this.__XSRFStrategy_3;
  }
  get _XHRBackend_4():import4.XHRBackend {
    if ((this.__XHRBackend_4 == (null as any))) { (this.__XHRBackend_4 = new import4.XHRBackend(this._BrowserXhr_1,this._ResponseOptions_2,this._XSRFStrategy_3)); }
    return this.__XHRBackend_4;
  }
  get _RequestOptions_5():import5.BaseRequestOptions {
    if ((this.__RequestOptions_5 == (null as any))) { (this.__RequestOptions_5 = new import5.BaseRequestOptions()); }
    return this.__RequestOptions_5;
  }
  get _Http_6():any {
    if ((this.__Http_6 == (null as any))) { (this.__Http_6 = import1.httpFactory(this._XHRBackend_4,this._RequestOptions_5)); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import9.LOCALE_ID)) { return this._LOCALE_ID_7; }
...
class JsonpModuleInjector extends import0.NgModuleInjector<import1.JsonpModule> {
  ...
  __BrowserJsonp_1:import10.BrowserJsonp;
  __ResponseOptions_2:import3.BaseResponseOptions;
  __JSONPBackend_3:import11.JSONPBackend_;
  ...
  get _BrowserJsonp_1():import10.BrowserJsonp {
    if ((this.__BrowserJsonp_1 == (null as any))) { (this.__BrowserJsonp_1 = new import10.BrowserJsonp()); }
  ...
  get _JSONPBackend_3():import11.JSONPBackend_ {
    if ((this.__JSONPBackend_3 == (null as any))) { (this.__JSONPBackend_3 = new import11.JSONPBackend_(this._BrowserJsonp_1,this._ResponseOptions_2)); }
    return this.__JSONPBackend_3;
  }
  get _RequestOptions_4():import5.BaseRequestOptions {
    if ((this.__RequestOptions_4 == (null as any))) { (this.__RequestOptions_4 = new import5.BaseRequestOptions()); }
    return this.__RequestOptions_4;
  }
  get _Jsonp_5():any {
    if ((this.__Jsonp_5 == (null as any))) { (this.__Jsonp_5 = import1.jsonpFactory(this._JSONPBackend_3,this._RequestOptions_4)); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import10.BrowserJsonp)) { return this._BrowserJsonp_1; }
    if ((token === import3.ResponseOptions)) { return this._ResponseOptions_2; }
    if ((token === import11.JSONPBackend)) { return this._JSONPBackend_3; }
    ...
    if ((token === import9.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_7; }
    return notFoundResult;
  }
  destroyInternal():void {
  }
